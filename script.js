// =========================================
// MIGRATION ANALYTICS WEB MAP - MAIN SCRIPT
// =========================================
...
// =========================================
// 2. DATA CONFIGURATION & LAYER DEFINITIONS
// =========================================
...
function getColor(d, layerKey) {
  ...
  if (isNaN(d)) {
    ...
    return '#cccccc'; // fallback color for invalid or missing data
  }
...
function loadLayer(layerKey) {
  ...
  fetch(geojsonData[layerKey])
    ...
    .then(data => {
      // Create new GeoJSON layer with styling and interactivity
      activeLayer = L.geoJSON(data, {
        ...
        onEachFeature: function (feature, layer) {
          // Create popup with all feature attributes
...
// Load migration reasons CSV data on page initialization
...
// =========================================
// 9. CHART CONFIGURATION & CREATION
// =========================================
...
// Handle district selection and chart generation
districtDropdown.addEventListener('change', () => {
  const selectedDistrict = districtDropdown.value;

  // Find district data in CSV
  ...
  // Extract migration reasons data
  const reasonsData = [
  ...
  // Create Migration Reasons Pie Chart
  ...
  // Create Duration of Residence Pie Chart
...
// Open Form Modal
  ...
  // Optional: Handle form submission (can be expanded to store or send data)
  ...
  document.getElementById('userInfoForm').addEventListener('submit', function (e) {
    ...
    // Redirect to the new infrastructure map interface
...
// Handle infrastructure button click (placeholder for future functionality)
